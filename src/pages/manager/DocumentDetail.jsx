...
import { ArrowLeftOutlined, ReloadOutlined, UserOutlined, BookOutlined, ScheduleOutlined } from '@ant-design/icons';
  ...
  useEffect(() => {
    if (document) {
      ...
      console.log("Date values:", {
        ...
        formattedCreatedDate: formatDate(document.createdDate || document.createDate)
      });
    }
  }, [document]);
                ...
                <Card className="shadow-sm">
                  ...
                  <Descriptions bordered column={2}>
                    <Descriptions.Item label="Mã hồ sơ" span={2}>
                      <span className="font-semibold text-[#B4925A]">#{document.documentId || document.fengShuiDocumentId}</span>
                    </Descriptions.Item>
                  ...
                  <Card 
                    ...
                    title={
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-lg font-medium">Thông tin đặt lịch</span>
                      </div>
                    }
                  >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="border border-gray-200 rounded-lg p-5 bg-gray-50">
                            <div className="flex items-center space-x-2 mb-3">
                              ...
                              <Title level={5} className="m-0">Thông tin đặt lịch</Title>
                            </div>
                            
                            <div className="grid grid-cols-1 gap-3">
                              <div>
                                <Text type="secondary">Mã đặt lịch:</Text>
                                <div className="font-medium mt-1">{document.bookingOffline.bookingOfflineId || "-"}</div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="border border-gray-200 rounded-lg p-5 bg-gray-50">
                            <div className="flex items-center space-x-2 mb-3">
                              ...
                              <Title level={5} className="m-0">Thông tin người tham gia</Title>
                            </div>
                            ...
                            <div className="grid grid-cols-1 gap-3">
                              <div>
                                ...
                                <div className="font-medium mt-1">
                                  {document.bookingOffline.customerName || "Chưa có thông tin"}
                                </div>
                              </div>
                              ...
                              <div>
                                ...
                                <div className="font-medium mt-1">
                                  {document.bookingOffline.masterName || "Chưa có thông tin"}
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="border border-gray-200 rounded-lg p-5 bg-gray-50">
                            ...
                            <div className="grid grid-cols-1 gap-3">
                              <div>
                                <Text type="secondary">Mã đặt lịch:</Text>
                                <div className="font-medium mt-1">{document.bookingProfile.bookingProfileId || "-"}</div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="border border-gray-200 rounded-lg p-5 bg-gray-50">
                            ...
                            <div className="grid grid-cols-1 gap-3">
                              <div>
                                <Text type="secondary">Khách hàng:</Text>
                                <div className="font-medium mt-1">
                                  {document.bookingProfile.customerName || "Chưa có thông tin"}
                                </div>
                              </div>
                              ...
                              <div>
                                <Text type="secondary">Chuyên gia:</Text>
                                <div className="font-medium mt-1">
                                  {document.bookingProfile.masterName || "Chưa có thông tin"}
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    <table className="w-full">
                      ...
                      <tbody className="divide-y divide-gray-200">
                        {document.attachments.map((attachment, index) => (
                          <tr key={attachment.id || index} className="hover:bg-gray-50">
                            <td className="py-3 px-6">{index + 1}</td>
                            <td className="py-3 px-6 font-medium">{attachment.fileName || "-"}</td>
                            <td className="py-3 px-6">{attachment.fileSize ? `${(attachment.fileSize / 1024).toFixed(2)} KB` : "-"}</td>
                            <td className="py-3 px-6">{formatDate(attachment.uploadDate)}</td>
