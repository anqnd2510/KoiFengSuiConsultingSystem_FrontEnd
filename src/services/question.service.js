...
const API_URL = "https://koifengshui-001-site1.ltempurl.com/api"; // Thay bằng URL API của bạn

// Tạo instance axios riêng cho question service
const questionApiClient = axios.create({
  baseURL: "https://koifengshui-001-site1.ltempurl.com",
});
...
export const getQuestionById = async (questionId) => {
  try {
    ...
    const response = await questionApiClient.get(
